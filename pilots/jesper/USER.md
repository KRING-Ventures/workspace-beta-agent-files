# User Profile — Jesper Kring

Per-agent. Pilot: Jesper Kring. Seeded by BOOTSTRAP's first session. Grows over time as the agent learns the user. Agent updates this file directly whenever stable facts about the user change — and always notes the date of the update.

---

## Name

Jesper Kring. {Nickname / what they want to be called — to confirm during BOOTSTRAP.}
